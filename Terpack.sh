...
BB="\033[34;1m" # Blue Light;YY="\033[33;1m" # Yellow Light;;G="\033[32;1m" # Green Light;WW="\033[0;1m"  # White Light;RR="\033[31;1m" # Red Light;CC="\033[36;1m" # Cyan Light;MM="\033[35;1m" # Magenta Light;B="\033[34;1m"  # Blue;Y="\033[33;1m"  # Yellow;G="\033[32;1m"  # Green;W="\033[0;1m"   # White;R="\033[31;1m"  # Red;C="\033[36;1m"  # Cyan;M="\033[35;1m"  # Magenta
echo -e "$CC #######$YY ##################$CC #######$YY ####################";echo -e "$CC    #    #####  #####          #     ####   ####  #     ";echo -e "$CC    #    #    # #    #         #    #    # #    # #     ";echo -e "$CC    #    #    # #    #  #####  #    #    # #    # #     ";echo -e "$CC    #    #    # #####          #    #    # #    # #     ";echo -e "$CC    #    #    # #   #          #    #    # #    # #     ";echo -e "$CC    #    #####  #    #         #     ####   ####  ######";echo -e "$YY ####################[$GG TheDarkRoot$YY ]####################";echo -e "$GG 0{======================$WW INFO $GG=======================}0";echo -e "$GG |$YY [$CC=$YY]$WW Name     $CC:$WW Terpack$GG                              |";echo -e "$GG |$YY [$CC=$YY]$WW Code     $CC:$WW Shell$GG                                |";echo -e "$GG |$YY [$CC=$YY]$WW Version  $CC:$WW v1.0.0 (Alpha)$GG                       |";echo -e "$GG |$YY [$CC=$YY]$WW Author   $CC:$WW TheDarkRoot$GG                          |";echo -e "$GG |$YY [$CC=$YY]$WW Email    $CC:$WW 7H3D4RKR007@gmail.com$GG                |";echo -e "$GG |$YY [$CC=$YY]$WW Github   $CC:$WW https://github.com/TheDarkRoot$GG       |";echo -e "$GG |$YY [$CC=$YY]$WW Telegram $CC:$WW @TheDarkRoot (t.me/TheDarkRoot)$GG      |";echo -e "$GG |$YY [$CC=$YY]$WW Team     $CC:$WW TurkHackTeam (www.turkhackteam.org)$GG  |";echo -e "$GG 0{===================================================}0"
