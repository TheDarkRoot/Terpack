...
clear;echo "$YY Installing ...";sleep 1;clear;echo "$YY Installing *..";sleep 1;clear;echo "$YY Installing .*.";sleep 1;clear;echo "$YY Installing ..*";sleep 1;clear;echo "$YY Installing ...";sleep 1;termux-setup-storage
